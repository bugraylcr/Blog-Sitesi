    ...
    <main>
        <div class="card">
            <form method="POST" action="/iletisim">
                ...
                <div class="field">
                    ...
                    <input id="name" name="ad" type="text" placeholder="Adınızı yazın" required>
                </div>
                <div class="field">
                    <label for="email">E-posta adresiniz <span>(gerekli)</span></label>
                    <input id="email" name="eposta" type="email" placeholder="ornek@eposta.com" required>
                </div>
                <div class="field">
                    <label for="subject">Konu</label>
                    <input id="subject" name="konu" type="text" placeholder="Konu başlığı">
                </div>
                <div class="field">
                    <label for="message">İletiniz</label>
                    <textarea id="message" name="mesaj" placeholder="Mesajınızı buraya yazın"  required></textarea>
                </div>
        ...
        <div class="social">
            ...
            <div class="social-links">
                ...
                <a href="https://www.instagram.com/bugra_ylcr/" aria-label="Instagram">
                ...
                <a href="https://www.linkedin.com/in/bugrayolacar/" aria-label="LinkedIn">
